...
import {TokenType} from "../src/lang/token/token.ts";
...
describe("Lexer double tokens", () => {
    ...
    test("tokenizes code with single-line comments", () => {
        const input = `
    ...
    test("tokenizes code with multi-line comments", () => {
        const input = `
      let x = 5;
      /* This is a
         multi-line comment */
    ...
    test("tokenizes code with nested multi-line comments", () => {
        const input = `
      let x = 5;
      /* Outer comment
         /* Nested comment */
